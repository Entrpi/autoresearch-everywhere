"""
CUDA data preparation implementation for autoresearch.
Top-level callers should prefer `uv run prepare.py --engine cuda`.
"""
...
def evaluate_bpb(model, tokenizer, batch_size):
    """Fixed upstream-shaped BPB helper used by the main trainer path."""
    return evaluate_bpb_configured(
        model,
        tokenizer,
        batch_size,
        seq_len=MAX_SEQ_LEN,
