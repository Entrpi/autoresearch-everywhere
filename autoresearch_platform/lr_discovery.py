...
LR_DISCOVERY_LEVER_SCALAR = "scalar"
LR_DISCOVERY_LEVER_EMBEDDING = "embedding"
LR_DISCOVERY_LEVERS = (
    LR_DISCOVERY_LEVER_GLOBAL,
    LR_DISCOVERY_LEVER_MATRIX,
    LR_DISCOVERY_LEVER_UNEMBEDDING,
    LR_DISCOVERY_LEVER_SCALAR,
    LR_DISCOVERY_LEVER_EMBEDDING,
)
...
_LR_DISCOVERY_LEVER_FIELDS = {
    ...
    LR_DISCOVERY_LEVER_SCALAR: "scalar_lr_multiplier",
    LR_DISCOVERY_LEVER_EMBEDDING: "embedding_lr_multiplier",
}
